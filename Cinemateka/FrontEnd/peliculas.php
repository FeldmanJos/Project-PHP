    ...
    <body>
        ...
        <div id="intro" class="intro">
            ...
            <!--<ul>
                <li>
                    <a href="">
                        <img src="img/cinemacenter.png" class="img-responsive" alt="img">
                    </a>
                </li>Cinemacenter - Carrefour
                <li>
                    <a href="">
                        <img src="img/costa.png" class="img-responsive" alt="img">
                    </a>
                </li>Cines de la Costa - Costanera
                <li>
                    <a href="">
                        <img src="img/costa.png" class="img-responsive" alt="img">
                    </a>
                </li>Cines de la Costa - Shopping
            </ul>-->
        </div>
        <div class="container">
            <div class="row">
